...
def _should_skip_missing_tools():
    """Check if missing tools should be skipped based on environment variables."""
    # Check CONAN_TEST_SKIP_MISSING_TOOLS=1
    if os.getenv("CONAN_TEST_SKIP_MISSING_TOOLS") == "1":
        return True
